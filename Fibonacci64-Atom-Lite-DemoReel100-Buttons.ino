...
ClickButton buttonPattern   (19, LOW, CLICKBTN_PULLUP); // Connect your button between pin 6 and GND
ClickButton buttonBrightness(23, LOW, CLICKBTN_PULLUP); // Connect your button between pin 7 and GND
...
void setup() {
  ...
  FastLED.setMaxPowerInVoltsAndMilliamps(5, 12 * NUM_LEDS); // 12mA for each LED recommended for max life
...
uint8_t currentPatternIndex = 21; // Index number of which pattern is current
